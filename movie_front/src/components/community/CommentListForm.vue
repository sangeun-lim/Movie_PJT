<template>
  <div>
    ...
    <form class="form p-0" @submit.prevent="onSubmit">
      <div class="input">
        <textarea type="text" placeholder="content"  v-model="content" style="height:50px" required></textarea>
        <label>
          <span>Comment</span>
        </label>
      </div>
      <center>
        <button class="custom-btn btn-14">Comment</button>
      </center>
    </form>
  </div>
</template>
